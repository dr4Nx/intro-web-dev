...
app.post("/submit", (req, res) => {
  ...
  let curra = Math.floor(Math.random() * adj.length);
  let currn = Math.floor(Math.random() * noun.length);
  res.render("index.ejs", { adj: adj[curra], noun: noun[currn], year: curryear });
});
