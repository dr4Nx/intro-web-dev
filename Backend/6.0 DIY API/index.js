...
app.put("/jokes/:id", (req, res) => {
  ...
  jokeid_index = jokes.findIndex((joke) => joke.id === parseInt(req.params.id));
  jokes[jokeid_index] = joke;
  res.json(joke)
});

//6. PATCH a joke
app.patch("/jokes/:id", (req, res) => {
  const orig_joke = jokes.find((joke) => joke.id === parseInt(req.params.id));
  const new_joke = {
    id: parseInt(req.params.id),
    jokeText: req.body.text || orig_joke.jokeText,
    jokeType: req.body.type || orig_joke.jokeType
  };
  jokeid_index = jokes.findIndex((joke) => joke.id === parseInt(req.params.id));
  jokes[jokeid_index] = new_joke;
  res.json(new_joke)
